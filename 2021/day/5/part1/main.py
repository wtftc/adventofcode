...
class VentLine:
    ...
    def allPoints(self):
        if self.isDiagonal():
            raise ValueError("diagonal not handled")
...
if __name__ == '__main__':
    exampleMap = Map()
    lines = readFile('C:/Users/bill/Code/projects/adventofcode/2021/day/5/part1/example.txt')
    breakpoint()
    ...
    inputMap = Map()
    lines = readFile('C:/Users/bill/Code/projects/adventofcode/2021/day/5/part1/input.txt')
